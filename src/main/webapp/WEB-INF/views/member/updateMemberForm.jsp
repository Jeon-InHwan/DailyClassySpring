...
<head>
<meta charset="UTF-8">
<title>Daily Classy 회원정보 수정</title>
...
<div id="outWrapper">
	<form action="/member/updateMember" id="updateForm" method="POST">
		<div class="input-group mb-3">
  			...
  			<input type="text" class="form-control" id="user_id" value="${member.user_id}" disabled="disabled" aria-label="user_id" aria-describedby="idSpan">
  		</div>
  		<div class="input-group mb-3">	
		...
		<div class="input-group mb-3">	
  			...
  			<input type="text" class="form-control" id="user_name" name="user_name" value="${member.user_name}" aria-label="user_name" aria-describedby="nameSpan">
		</div>
	</form>
</div>	

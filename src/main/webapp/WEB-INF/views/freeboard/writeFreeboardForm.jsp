...
<script type="text/javascript" src="/resources/js/writeFreeboardForm.js"></script>
<link rel="stylesheet" type="text/css" href="/resources/css/writeFreeboardForm.css">
...
<form action="/freeboard/writeFreeboard" id="writeFreeboard" method=POST>
	<div id="tableWrapper">
		<div id="tableDiv"> 
			<table class="table table-dark table-hover" id="feeboardTable">
				<tr>
					<th id="idTh">ID</th>
				...
				<tr>
					...
					<td>
						<div class="input-group mb-3">	
  							<input type="text" class="form-control" name="fb_title" id="fb_title" placeholder="" aria-label="fb_title" aria-describedby="basic-addon1">
  						</div>
					</td>
				</tr>
				<tr>
					...
					<td id="contentTd">
						<div class="form-floating">
  							<textarea class="form-control" name = "fb_content"  id="fb_content"></textarea>
						</div>
					</td>
				</tr>
			</table>
...
<div id="buttonDiv">
	<input type="button" id="writeButton" class="btn btn-secondary btn-lg" value="자유게시판 작성" onclick="writeFreeboardCheck();">
</div>
